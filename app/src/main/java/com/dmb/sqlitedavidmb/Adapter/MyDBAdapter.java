...
import com.dmb.sqlitedavidmb.Model.Teacher;
...
public class MyDBAdapter {
    ...
    private static final String DATABASE_NAME = "SQLiteDavidMB.db";
    ...
    public MyDBAdapter (Context c){
        ...
        open();
        //searchStudents("SELECT * FROM estudiantes;");
    }
    ...
    //(!!! PARTE EXAMEN !!!)
    //Nos creamos un método para insertar las asignaturas

    public void insertSubject(String nombre, int horas){
        db = dbHelper.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
        contentValues.put("nombre",nombre);
    ...
    //(!!! PARTE EXAMEN !!!)
    //Nos creamos un método el cual utilizamos para realizar la búsqueda de asignaturas

    public ArrayList<Subject> searchSubject(String sql){
        db = dbHelper.getReadableDatabase();
    ...
    //(!!! PARTE EXAMEN !!!)
    //Nos creamos un método para realizar la eliminacion de alguna asignatura
